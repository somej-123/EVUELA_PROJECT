...
const Join = () => {
  ...
  const checkDataForm = yup.object().shape({
    ...
    name : yup.string().required("비밀번호를 입력해주세요"),
    email : yup.string().required("비밀번호를 입력해주세요").matches(
          ...
          <section id='navSection'>
            ...
            <section id='login_bodySection' style={{marginTop:"50px"}}>
              ...
              <div className="form">
                ...
                <form className='login-form' onSubmit={handleSubmit(onJoin,fail)}> {/* onSubmit={ (e) => onJoin(e) }*/}
                    <div>
